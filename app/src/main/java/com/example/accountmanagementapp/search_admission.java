...
public class search_admission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_admission);
        ...
        edetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(search_admission.this, admission_details.class);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(search_admission.this, EditAdmissionActivity.class);
                startActivity(intent);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(search_admission.this, home.class);
                startActivity(intent);
    ...
    class SearchAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String result = "";
            try {
                URL url = new URL(Config.BASE_URL + "search_admission.php?Name=" + Name + "&roll=" + roll);
                ...
                e.printStackTrace();
                Toast.makeText(search_admission.this, "No records found", Toast.LENGTH_SHORT).show();
            }
            return result;
        }
        ...
        private void displayTable(TableLayout tableLayout, String tableName, JSONArray jsonArray) throws JSONException {
            ...
            TableRow headersRow = new TableRow(search_admission.this);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                TableRow row = new TableRow(search_admission.this);
        ...
        private TextView createTextView(String text, boolean isHeader) {
            TextView textView = new TextView(search_admission.this);
        ...
        private TextView createHeadingTextView(String text) {
            TextView headingTextView = new TextView(search_admission.this);
